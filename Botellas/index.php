...
<!-- Formulario para ingresar altura y base -->
    <div style="width: 75vh; background-color: burlywood; padding: 1vh; position: absolute; top:25%; left: 25%; ">
        ...
        <form id="area-form">
            ...
            <div class="mb-3">
                <label for="cantidad" class="form-label">Cantidad de botellas:</label>
            ...
            <a href="repHist.php">Reporte de pedidos</a>
...
<script>
    ...
    if (!isNaN(cedula) && !isNaN(cantidad)) {
        var parametros = {"cedula": cedula, "cantidad": cantidad};
        $.ajax({
            url: "assets/ejecutar.php",
            type: "post",
            data: parametros,
        beforeSend: function() {
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            ...
            $("#resultado").html("Error al realizar la operación");
        }        
        });
    } else {
